...
Array.prototype.in_array = function (element) { 
    ...
    export default {
        install(Vue, options) {
                ...
                tigTypeList:[
                    {
                        ...
                        comList:[
                            {key:'PULSE',value:'PULSE'},{key:'NOPULSE',value:'NO PULSE'}
                        ]
                    },{
                        typeName:'IFHF',
                        chooseKey:'HF',//默认选中
                        comList:[
                            {key:'HF',value:'HF'},{key:'LIFT',value:'LIFT'}
                        ]
                    }
                ],
                /** MIGMAN**/
                ...
                migsynTypeList:[
                    {
                        ...
                        chooseKey:'FE',//默认选中
                        comList:[
                            {key:'FE',value:'FE'},{key:'SS',value:'SS'},{key:'AL',value:'AL'},{key:'FCAW-S',value:'FCAW-S'},{key:'FCAW-G',value:'FCAW-G'}
                        ]
                    },{
                        // typeName:'GAS',
                        // chooseKey:'Ar',//默认选中
                        ...
                        chooseKey:'CO2',//默认选中
                        comList:[
                            {key:'MIX',value:'MIX'},{key:'CO2',value:'CO2'}
                        ]
                    },{
                        typeName:'DIAMETER',
                        chooseKey:'6MM',//默认选中
                        ...
                        chooseKey:'6MM',//默认选中
                        comList:[
                            {key:'6MM',value:'0.6mm'},{key:'7MM',value:'0.7mm'},{key:'9MM',value:'0.9mm'},{key:'12MM',value:'1.2mm'},{key:'16MM',value:'1.6mm'},{key:'21MM',value:'2.1mm'},{key:'28MM',value:'2.8mm'},{key:'34MM',value:'3.4mm'},{key:'48MM',value:'4.8mm'},{key:'64MM',value:'6.4mm'},{key:'80MM',value:'8.0mm'},{key:'95MM',value:'9.5mm'}
                            ,{key:'110MM',value:'11mm'},{key:'127MM',value:'12.7mm'}
                        ]
                    }
                ]
               ...
               switch (type) {
                   case weldDirctive.migSyn:
                        ...
                        if(arrayList[1]=='225' &&arrayList.length==17){
                            ...
                            rstInfo.GAS=setWeldParams('GAS',arrayList[4]);
                            rstInfo.DIAMETER=setWeldParams('DIAMETER',arrayList[5]);
                            rstInfo.THICKNESS=setWeldParams('THICKNESS',arrayList[6]);
                            ...
                            rstInfo.SPEED_DISPLAY =arrayList[11];
            ...
            //    console.log('111'+JSON.stringify(rstInfo))
               return rstInfo;
             }
            //比较字符串是否相等 忽略大小写
